class GetStudentPurchasedCourseDetailsModel {
  final bool? error;
  final String? status;
  final String? message;
  final List<PurchasedCourseDetails>? result;

  GetStudentPurchasedCourseDetailsModel({
    this.error,
    this.status,
    this.message,
    this.result,
  ...
  GetStudentPurchasedCourseDetailsModel.fromJson(Map<String, dynamic> json)
      : error = json['error'] as bool?,
        status = json['status'] as String?,
        message = json['message'] as String?,
        result = json['result'] == null ? null : List<PurchasedCourseDetails>.from(json['result'].map((x)=>PurchasedCourseDetails.fromJson(x)));
...
class PurchasedCourseDetails {
  ...
  PurchasedCourseDetails.fromJson(Map<String, dynamic> json)
