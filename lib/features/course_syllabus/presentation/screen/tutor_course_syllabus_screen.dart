...
class TutorCourseSyllabus extends ConsumerStatefulWidget {
  const TutorCourseSyllabus({super.key});
  @override
  ConsumerState<TutorCourseSyllabus> createState() => _CourseSyllabus();
}

class _CourseSyllabus extends ConsumerState<TutorCourseSyllabus> {
  @override
            ...
            Expanded(
              child: Container(
                ...
                child: SingleChildScrollView(
                  child: Form(
                    key: mCourseSyllabusProvider.formKey,
                    child: Column(
                      children: [
                        ...
                        if (mCourseSyllabusProvider.selectedEnroll == 'K-12')
                          Padding(
                            ...
                            child: CustomDropdown(
                              ...
                              onGradeChanged: (selectedGrade) {
                                ...
                                mCourseSyllabusProvider.updateSelectedGrade(selectedGrade);
                                mCourseSyllabusProvider.validateDropDown(selectedGrade);
                        ...
                        AppDropDownTextField(
                          ...
                          autoValidateMode: AutovalidateMode.onUserInteraction,
                          onChanged: (selectedItem) {
                            mCourseSyllabusProvider.updateSelectedTimeZone(
                                selectedItem!);
                          },
                        ),
                        vHeight(14.h),
                        ...
                        PrimaryAppButton(
                          ...
                          onTap: () {
                            mCourseSyllabusProvider.tutorCourseRegistration();
                          },
                        ),
                        vHeight(40.h),
                      ],
  ...
  Widget _price() {
    ...
    return PrimaryTextField(
      ...
      prefix: const Text('\$'),
      controller: mCourseSyllabusProvider.price,
      validator: TextFieldValidator.price,
      maxLength: 30,
      autoValidateMode: AutovalidateMode.onUserInteraction,
      textInputAction: TextInputAction.next,
    );
  ...
  Widget _uploadSyllabusWidget() {
    return Consumer(
      builder: (context, ref, _) {
        var mCourseSyllabusProvider = ref.watch(tutorCourseSyllabusProvider);
        return InkWell(
          onTap: () => mCourseSyllabusProvider.pickDocument(),
          child: Container(
            width: double.infinity,
            decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(18),
          ...
          child: InkWell(
            onTap: () async {
              ...
              if (picked != null &&
                ...
                setState(() {
                  mCourseSyllabusProvider.forFromDate = formattedDate;
          ...
          child: InkWell(
            onTap: () async {
              ...
              if (picked != null && picked != mCourseSyllabusProvider.toDate) {
                String formattedDate = DateFormat('yyyy-MM-dd').format(picked);
                setState(() {
                  mCourseSyllabusProvider.forToDate = formattedDate;
          ...
          child: InkWell(
            onTap: () async {
              ...
              if (selectedTime != null) {
                ...
                String formattedTime = '${selectedTime.hour.toString().padLeft(
          ...
          child: GestureDetector(
            onTap: () async {
              ...
              if (selectedTime != null) {
                ...
                String formattedTime = '${selectedTime.hour.toString().padLeft(
                    2, '0')}:${selectedTime.minute.toString().padLeft(2, '0')}';
                if (mCourseSyllabusProvider.startTime != null &&
                    selectedDateTime.isBefore(
                        mCourseSyllabusProvider.startTime!)) {
